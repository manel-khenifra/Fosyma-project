...
public final class ConfigurationFile {
	...
	//public static String INSTANCE_TOPOLOGY="resources/map2021-topologyExam1-graph.dgs";
	...
	//public static String INSTANCE_CONFIGURATION_ENTITIES="resources/map2021-entitiesGraph";
	
	//public static String INSTANCE_CONFIGURATION_ENTITIES="resources/agentExploCoop-3";
